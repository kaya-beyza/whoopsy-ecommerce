...
public interface IProductRepository
{
    ...
    Task<(List<Product> Items, int TotalCount)> GetByFilterAsync(Gender? gender, Brand? brand, Guid? categoryId, string? searchTerm, CancellationToken cancellationToken, int? page = null, int? pageSize = null);
    // Image metodları
